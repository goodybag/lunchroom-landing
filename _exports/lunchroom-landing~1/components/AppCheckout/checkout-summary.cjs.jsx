  ...
  <div className="order-summary-wrapper">
    <div className="order-summary">
      <div className="order-summary-item">
        ...
        <div className="order-summary-col order-summary-value" data-component-prop="format.amount">$8.80</div>
      </div>
      <div className="order-summary-item">
        <div className="order-summary-col order-summary-key">Tax</div>
        <div className="order-summary-col order-summary-value" data-component-prop="format.taxAmount">$0.73</div>
      </div>
      <div className="order-summary-item">
      ...
      <div className="order-summary-item order-summary-item-total">
        ...
        <div className="order-summary-col order-summary-value" data-component-prop="format.total">$12.37</div>
      </div>
    </div>
