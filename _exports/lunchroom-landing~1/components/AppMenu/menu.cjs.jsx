module.exports = function (Context) {
  ...
  <div className="tiles item-tiles" data-component-section="items">
      <div className="tile item-tile hidden" data-component-section="items" data-component-view="default">
        ...
        <div className="tile-info">
          ...
          <ul className="diet-tags" data-component-section="diet-tags">
              <li className="diet-tag diet-tag-gluten-free hidden" data-component-section="diet-tags" data-component-view="default"></li>
          ...
          <div className="item-tile-actions">
            <button className="btn btn-default btn-remove hidden" data-component-elm="removeButton" data-component-view="orderable">-</button><button className="btn btn-default btn-add hidden" data-component-elm="addButton" data-component-view="orderable">Add</button>
          </div>
        </div>
      </div>
      <div className="tile item-tile is-in-cart hidden" data-component-section="items" data-component-view="default">
        <div className="tile-cover" style={{"backgroundImage":"url('https://www.filepicker.io/api/file/SZoK9zUvTPWXzmK81aGg/convert?w=400&amp"}} data-component-prop="photoUrl" data-component-prop-target="style/background-image" data-component-elm="showDetailsLink" data-toggle="modal" data-target="#item-modal">
          <div className="item-tile-quantity-wrapper">
        ...
        <div className="tile-info">
          ...
          <ul className="diet-tags" data-component-section="diet-tags">
              <li className="diet-tag diet-tag-vegan hidden" data-component-section="diet-tags" data-component-view="default"></li>
              <li className="diet-tag diet-tag-vegetarian hidden" data-component-section="diet-tags" data-component-view="default"></li>
          </ul>
